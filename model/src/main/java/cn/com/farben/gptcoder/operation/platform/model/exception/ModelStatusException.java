 ...
 * 创建时间: 2023/8/28
 * @author ltg
 * @apiNote 模型状态异常类，错误码参见{@link ErrorCodeEnum#USER_ERROR_A0508}
 *
 */
public final class ModelStatusException extends BusinessException {
    @Serial
     ...
     * @param message 错误消息
     */
    public ModelStatusException(String message) {

 ...
 * 创建时间: 2023/10/18
 * @author ltg
 * @apiNote 下载文件异常类，错误码参见{@link ErrorCodeEnum#USER_ERROR_A0500}
 *
 */
public final class DownloadException extends BusinessException {
    @Serial
    ...
    public DownloadException(String message) {
        super(ErrorCodeEnum.USER_ERROR_A0500, message);
    }
}
